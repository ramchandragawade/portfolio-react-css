...
const Modal = ({ isOpen, onClose, projectData }) => {
	...
	return ReactDOM.createPortal(
        <div className="fixed top-0 left-0 right-0 bottom-0 bg-modal-bg z-50 flex flex-col justify-center items-center">
            <div className="p-2 flex flex-col justify-center items-center gap-2 font-[Outfit] text-white bg-[#161513] rounded-lg min-w-full max-w-full md:min-w-[75%] md:max-w-[75%] text-center relative">
                ...
                <div className="md:w-[75%] h-auto items-center overflow-hidden relative rounded-lg">
                    <img src={imgs[0]} alt={title} className="object-cover w-full" />
                </div>
                <p className='font-thin min-w-full max-w-full md:min-w-[90%] md:max-w-[90%]'>{description}</p>
