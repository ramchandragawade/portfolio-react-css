			...
			<div className="flex flex-row w-full justify-evenly">
				<div className='flex flex-row items-center text-white gap-2'>
					<div className='rounded-2xl hover:scale-110 duration-300 transition-all ease-in relative group'>
						...
						<div className="text-center absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-1 text-sm text-white bg-gray-800 rounded hidden group-hover:block transition-all duration-200">
							View Code
						</div>
					</div>
					{
